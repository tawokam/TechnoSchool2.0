...
<thead class="table-primary">
  <tr><th colspan=2></th><th>N°</th><th> Nom de l\'employer</th><th>Téléphone 1</th><th>Téléphone 2</th><th>Sexe</th><th>Adresse mail</th><th>Fonction</th><th>Quartier</th><th>Diplome</th><th>Spécialité</th><th>CV</th><th>Numèro d\'urgence</th></tr>
  </thead>';
if($sexe == '' && $diplome == '' && $fonction == ''){
    ...
    if($sel = $connec->query($se)){
        while($sele = $sel->fetch()){
            ...
            echo '<tr id="ligne'.$sele['id_employer'].'"><td><input class="form-check-input" id="'.$sele['id_employer'].'" onchange="listemployerselectsupp(this.id)" style="border:1px solid blue" type="checkbox"></td><td style="cursor:pointer;color:gray;" id="'.$sele['id_employer'].'" onclick="suppUnEmployer(this.id)"><i class="bi bi-trash3-fill text-danger"></i> Effacer</td><td>'.$n.'</td><td>'.$sele['nom_employer'].'</td><td>'.$sele['telephone1_employer'].'</td><td>'.$sele['telephone2_employer'].'</td><td>'.$sele['sexe_employer'].'</td><td>'.$sele['adresseMail_employer'].'</td><td>'.$sele['nom_fonction'].'</td><td>'.$sele['quartier_employer'].'</td><td>'.$sele['grandiplome'].'</td><td>'.$sele['specialitediplome'].'</td><td>'.$sicv.'</td><td>'.$sele['numerourgence'].'</td></tr>';
            $n++;
        }
    }
