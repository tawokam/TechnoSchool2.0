...
Veuillez cliquer sur une classe pour voir la liste des enseignants programmés pour une modification.
</div>';
...
if($sel = $connec -> query($se)){
    while($sele = $sel -> fetch()){     
        echo '<tr id="'.$sele['id_classe'].'" style="cursor:pointer" onclick="profprogrammemodif(this.id)"><td>'.$n.'</td><td>'.$sele['nom_classe'].'</td><td>'.$sele['nom_section'].'</td></tr>';
        $n++;
    }
}
echo '</table>';
