...
?>
        <tr id="<?php echo $sele['id_classe']; ?>" style="cursor: pointer;" onclick="affichbuletin(this.id,'<?php echo $sequence?>')" class="linejustabsent"><td><?php echo $nbr;?></td><td><?php echo $sele['nom_classe'];?></td><td><?php echo $sele['nom_section'];?></td></tr>
<?php
$nbr++;
    }
}
