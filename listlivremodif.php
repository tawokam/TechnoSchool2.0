...
<div class="card-body">
  ...
  <div class="alert alert-info bg-info text-light" role="alert" style="font-size: 12px;">
       Veuillez cliquer sur le livre que vous souhaitez modifier pour accéder au formulaire de modification du livre en question 
</div>
<form class="row g-3">
<div class="col-md-12">
      <label for="nomlivrelistmodif" class="form-label">Nom du livre</label>
      <input type="text" class="form-control" id="nomlivrelistmodif" placeholder="Recherche..." onkeyup="listlivrecriteresmodif()">
</div></form><br>

<?php
require('connect.php');
echo '<div id="zonelistlivremodif">';
