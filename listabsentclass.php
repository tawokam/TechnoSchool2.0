...
Veuillez sélectionner une classe pour obtenir la liste des élèves absents.
</div>';
  ...
  <tr><th>N°</th><th> Nom de la classe</th><th>Section</th></tr>
    ...
    if($sel = $connec->query($se)){
        while($sele = $sel->fetch()){
            ...
            echo '<tr id="'.$sele['id_classe'].'" onclick="listabsent(this.id)" style="cursor:pointer"><td>'.$n.'</td><td>'.$sele['nom_classe'].'</td><td>'.$sele['nom_section'].'</td></tr>';
            $n++;
        }
    }
