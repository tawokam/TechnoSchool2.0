...
Veuillez cliquer sur une classe pour voir l\'emploi du temps concerné
</div>';
...
if($sel = $connec -> query($se)){
    while($sele = $sel -> fetch()){     
        echo '<tr id="'.$sele['id_classe'].'" style="cursor:pointer" onclick="emploitempsclasse(this.id)"><td>'.$n.'</td><td>'.$sele['nom_classe'].'</td><td>'.$sele['nom_section'].'</td></tr>';
        $n++;
    }
}
echo '</table>';
