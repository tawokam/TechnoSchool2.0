...
Veuillez cliquer sur une classe pour obtenir la liste des différentes notes attribuées à chaque élève pour une matière.
</div>';
...
?>
        <tr id="<?php echo $sele['id_classe']; ?>" style="cursor: pointer;" onclick="listnoteclasseX(this.id)"><td><?php echo $nbr;?></td><td><?php echo $sele['nom_classe'];?></td><td><?php echo $sele['nom_section'];?></td></tr>
<?php
$nbr++;
    }
}
