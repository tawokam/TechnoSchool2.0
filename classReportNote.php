...
Veuillez cliquer sur une classe
</div>';
...
?>
        <tr id="<?php echo $sele['id_classe']; ?>" style="cursor: pointer;" onclick="affichformreportnotes(this.id)" class="linejustabsent"><td><?php echo $nbr;?></td><td><?php echo $sele['nom_classe'];?></td><td><?php echo $sele['nom_section'];?></td></tr>
<?php
$nbr++;
    }
}
